...
Another one. Same patching strategy. Different password obfuscation. 

```bash
$ ./crackme02e_helper -2 yuvmnpoi
wstklnmg
```
...
Need exactly one argument.
255
$ ./crackme02e test || echo $?
No, test is not correct.
1
$ ./crackme02e wstklnmg || echo $?
Yes, wstklnmg is correct!
```

```bash
$ ./crackme02e_hacked || echo $?
Need exactly one argument.
255
$ ./crackme02e_hacked test || echo $?
Yes, test is correct!
$ ./crackme02e_hacked wstklnmg || echo $?
No, wstklnmg is not correct.
1
```
